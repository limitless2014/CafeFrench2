...
export default class V3 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      {title:'entreprendre',key:'entreprendre',trans:'انجام دادن ، تقبل کردن ، دست کم گرفتن',ph:'[ɑ̃tʀəpʀɑ̃dʀ]'},
      ...
      {title:'fleuve',key:'fleuve',trans:'شریان رودخانه ، بی پایان',ph:'[flœv]'},
      ...
      {title:'nomade',key:'nomade',trans:'خانه بدوش ، عشایر',ph:'[nɔmad]',cat:'N'},
      ...
      {title:'prendre pour',key:'prendre pour',trans:'کسی را چیزی فرض کردن',ph:'[pʀɑ̃dʀ]'},
