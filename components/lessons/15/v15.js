...
export default class V3 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      {title:'caisse',key:'caisse',trans:'صندوق ، پرونده ، کیس ، قیمت',ph:'[kɛs]',cat:'C'},
      ...
      {title:'lassitude',key:'lassitude',trans:'خستگی ، ضعف',ph:'[lɑsityd]',cat:'L'},
      ...
      {title:'réservé',key:'réservé',trans:'رزرو شده ، محافظه کار',ph:'[ʀezɛʀve]'},
      ...
      {title:'vouloir (en ... à)',key:'vouloir (en ... à)',trans:'کینه کسی را داشتن ، چیزی را خواستن ، کسی را سرزنش کردن',ph:'[vulwaʀ]'},
    ],
    search:[],
    };
