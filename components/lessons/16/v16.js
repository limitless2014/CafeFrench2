...
export default class V3 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      {title:'étourdir',key:'étourdir',trans:'بی حس کردن ،بیهوش کردن ، گیج کردن',ph:'[etuʀdiʀ]'},
      ...
      {title:'initier',key:'initier ',trans:'شروع به یادگیری اصول کردن',ph:'[inisje]'},
      ...
      {title:'messe de minuit',key:'messe de minuit',trans:'مراسم عشای ربانی ',ph:'[mɛs də minɥi]'},
      ...
      {title:'œuvre',key:'œuvre',trans:'اثر هنری',ph:'[œvʀ]'},
      ...
      {title:'saharien',key:'saharien',trans:'ساهارایی (بیابانی در افریقا)',ph:'[saharien]',cat:'S'},
