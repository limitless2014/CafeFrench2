...
export default class V3 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      {title:'Micro-trottoir',key:'Micro-trottoir',trans:'خبرنگار سیار ، صدای مردم',ph:'[mikʀo tʀɔtwaʀ]'},
      ...
      {title:'réduction',key:'réduction',trans:'کاهش ، تخفیف',ph:'[ʀedyksjɔ̃]'},
      ...
      {title:'sortie',key:'sortie',trans:'خروجی ، بیرون رفتن',ph:'[sɔʀti]'},
